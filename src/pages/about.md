...
Dylan is a product-minded UX designer and content strategist in Seattle. He has written, designed, and built online experiences for over 10 years at companies like Pinterest and Ancestry. He thrives where clever solutions are celebrated and efficient systems are a must on the way to delivering awesome products and accessible user experiences.

The green color on this site <span class="hex-light">#729B4D</span> <span class="hex-dark">#5C7A4E</span> is sampled from photos of his many houseplants, and the site itself was built using a modded ThinkPad T480 running Linux Mint. Dylan is learning ASL and Spanish while his Chihuahua communicates using talking buttons. The Chihuahua is also bilingual.
