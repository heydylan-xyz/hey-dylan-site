...
flowchart TD
  Start((Start)) --> Welcome["Welcome to City Pet Vet. Let's make sure your pet gets the right care."]
  Welcome --> EmergencyGate{"Emergency symptoms? • Difficulty breathing • Seizures • Severe trauma • Unconsciousness"}
  ...
  ServiceSelect --> SymptomCheck{"New symptoms or health concerns?"}
  ...
  Login --> Success(("Veterinary Consultation Booked with DVM"))
...
flowchart TD
  ...
  Login --> ActiveCase{"Active surgical plan or oncology case on file?"}
  ActiveCase -- Yes --> Continuity(("Specialized Follow-up Treatment or re-check"))
...
flowchart TD
  ...
  Availability -- Yes --> UrgentConsult(("Urgent Consultation Same-day fit-in"))
  Availability -- No --> RedFlag{"Critical symptoms present?"}
  RedFlag -- Yes --> WalkIn(("Walk-in Immediate Triage"))
  RedFlag -- No --> SafetyValve(("Triage Callback  Partner ER Referral"))
  style UrgentCare fill:#636363,stroke:#484848,color:#f8f8f8
